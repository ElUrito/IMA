...
log_signal = scipy.signal.chirp(t, f0=100, f1=1000, t1=T, method='logarithmic')
...
# Guardado de sweep en forma de audio

sf.write('sine_sweep.wav', log_signal, fs)
#sf.write('inv_sine_sweep.wav', loginv_signal, fs)
