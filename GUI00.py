...
class Window(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowIcon(QtGui.QIcon('untref.ico'))
        ...
        self.botonrad1 = QRadioButton("Octava")
        self.botonrad1.setChecked(False)
        ...
        self.botonrad2 = QRadioButton("Tercio de octava")
...
#Functions
    ...
    def aguanteFede2(self):
        ...
        #self.mmovil = moving_average(np.array(self.signals), 5)
        self.mmovil = moving_average(np.array(self.signals), 5)
        # ejexmisley = np.linspace(0,20000)
        maxVal = np.max(self.mmovil)
...
def tercio(data, fs):
    ...
    xticks = [25, 31.5, 40, 50, 63, 80, 100, 125, 160, 200, 250, 315, 400, 500, 630, 800, 1000, 1250, 1600,
...
"""-poner Lundeby
-poner Schroeder (Franquito lo tiene que subir al GitHub)
-que el usuario pueda cargar el filtro inverso
-que calcule la RI
-implementar:
    -Edt
    -C50 y C80
